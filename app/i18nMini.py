messages = {
    "uz": {
        ...
        "errors": {
            ...
            "salon_not_found": "Salon topilmadi",
            "schedule_not_found": "Jadval topilmadi",
            "employee_not_found": "Xodim topilmadi",
            "service_not_found": "Xizmat topilmadi",
            "service_duration_invalid": "Xizmat davomiyligi noto'g'ri",
            "date_not_specified": "Sana aniqlanmadi",
            "time_not_specified": "Vaqt kiritilmagan",
            "customer_name_required": "Mijoz ismi majburiy",
            "time_out_of_schedule": "Tanlangan vaqt jadval oralig'ida emas",
            "service_end_out_of_schedule": "Xizmat tugash vaqti jadval oralig'ida emas",
            "master_busy": "Bu vaqtda master band",
            "login_required_for_payment": "To'lov uchun login talab qilinadi",
            "card_id_required": "Karta ID majburiy",
            "card_id_required_prepay": "Oldindan to'lov uchun karta ID majburiy",
            "payment_card_not_found": "To'lov kartasi topilmadi",
            "payment_card_not_found_or_not_verified": "To'lov kartasi topilmadi yoki tasdiqlanmagan",
    ...
    "ru": {
        ...
        "errors": {
            ...
            "403": "Нет доступа",
            "400": "Неверный запрос",
            "salon_not_found": "Салон не найден",
            "schedule_not_found": "Расписание не найдено",
            "employee_not_found": "Мастер не найден",
            "service_not_found": "Услуга не найдена",
            "service_duration_invalid": "Неверная длительность услуги",
            "date_not_specified": "Дата не указана",
            "time_not_specified": "Время не указано",
            "customer_name_required": "Имя клиента обязательно",
            "time_out_of_schedule": "Выбранное время вне диапазона расписания",
            "service_end_out_of_schedule": "Время окончания услуги вне диапазона расписания",
            "master_busy": "На это время мастер уже занят",
            "login_required_for_payment": "Для оплаты требуется авторизация",
            "card_id_required": "ID карты обязателен",
            "card_id_required_prepay": "ID карты обязателен для предоплаты",
            "payment_card_not_found": "Платежная карта не найдена",
            "payment_card_not_found_or_not_verified": "Карта не найдена или не подтверждена",
    ...
    "en": {
        ...
        "errors": {
            ...
            "employee_not_found": "Master not found",
            "service_not_found": "Service not found",
            "service_duration_invalid": "Invalid service duration",
            "date_not_specified": "Date is not specified",
            "time_not_specified": "Time is not specified",
            "customer_name_required": "Customer name is required",
            "time_out_of_schedule": "Selected time is outside schedule range",
            "service_end_out_of_schedule": "Service end time is outside schedule range",
            "master_busy": "Master is already busy at this time",
            "login_required_for_payment": "Login is required for payment",
            "card_id_required": "Card ID is required",
            "card_id_required_prepay": "Card ID is required for prepayment",
            "payment_card_not_found": "Payment card not found",
            "payment_card_not_found_or_not_verified": "Card not found or not verified",
